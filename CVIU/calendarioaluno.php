...
function MostreCalendario( $mes  )
{
	...
	/*echo "<table border = 0 cellspacing = '0' align = 'center'>";
	 echo "<tr>";
         echo "<td colspan = 7><h3>".$nome_mes."</h3></td>"; //imprime o mes -- VOU RETORNAR NOME_MES
	 echo "</tr>";
	 echo "<tr>";
	   MostreSemanas();	// função que mostra as semanas aqui // POSSO DEIXAR O HTML ESTATICO PARA ESSA FUNCAO
	 echo "</tr>";*/
...
function MostraNaMesmaFuncao($mes){
	$numero_dias = GetNumeroDias( $mes );	// retorna o número de dias que tem o mês desejado
	$nome_mes = GetNomeMes( $mes );
	$diacorrente = 0;	
	...
	echo "<table border = 0 cellspacing = '0' align = 'center'>";
	 echo "<tr>";
         echo "<td colspan = 7><h3>".$nome_mes."</h3></td>"; //imprime o mes
	 echo "</tr>";
	 echo "<tr>";
